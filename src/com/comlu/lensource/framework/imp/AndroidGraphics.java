...
public class AndroidGraphics implements Graphics {
	...
	public AndroidGraphics(AssetManager assets, Bitmap frameBuffer){
		...
		this.font = Typeface.createFromAsset(assets, "fonts" + File.separator + "retro.ttf");
	}
	...
	@Override
	public void drawText(String text, int x, int y, int size, String fontName, int color) {
		paint.setColor(color);
